...
const auth = betterAuth({
  // Database configuration - provide connection string directly
  // Better Auth will manage its own connection pool
  database: {
    provider: 'postgres',
  ...
  secret: process.env.BETTER_AUTH_SECRET || 'fallback-secret-for-development-only-min-32-chars-long',
