...
logger.info('Initializing Better Auth with database...');

/**
 * Better Auth instance with optimized configuration
 */
const auth = betterAuth({
  // Database configuration - Better Auth v1.4.7 requires object format
  // CRITICAL FIX: Must be { provider, url }, NOT just string
  database: {
    provider: 'postgres',
